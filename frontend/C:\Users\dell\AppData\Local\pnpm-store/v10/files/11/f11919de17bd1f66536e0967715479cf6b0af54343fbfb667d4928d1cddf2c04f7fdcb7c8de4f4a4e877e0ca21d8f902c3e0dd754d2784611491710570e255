 ...
 */
declare const generateHttpClientImplementation: ({ headers, queryParams, operationName, typeName, response, mutator, body, props, verb, override, formData, formUrlEncoded, paramsSerializer, paramsFilter }: GeneratorVerbOptions, { route: _route, context }: HttpClientGeneratorContext) => string;
/**
