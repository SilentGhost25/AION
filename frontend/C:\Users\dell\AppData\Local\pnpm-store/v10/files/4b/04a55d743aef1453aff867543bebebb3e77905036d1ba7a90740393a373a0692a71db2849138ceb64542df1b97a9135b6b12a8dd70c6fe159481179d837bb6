...
declare function getParams({ route, pathParams, operationId, context, output }: GetParamsOptions): GetterParams;
//#endregion
...
declare function writeSchemasTagsSplit({ schemaPath, schemas, target, namingConvention, fileExtension, header, indexFiles, tsconfig, factoryOutputDirectory, operations }: WriteSchemasTagsSplitOptions): Promise<void>;
//#endregion
//#region src/writers/single-mode.d.ts
declare function writeSingleMode({ builder, output, projectName, header, needSchema, generateSchemasInline, schemaTagMap }: WriteModeProps): Promise<string[]>;
//#endregion
//#region src/writers/split-mode.d.ts
declare function writeSplitMode({ builder, output, projectName, header, needSchema, generateSchemasInline, schemaTagMap }: WriteModeProps): Promise<string[]>;
//#endregion
//#region src/writers/split-tags-mode.d.ts
declare function writeSplitTagsMode({ builder, output, projectName, header, needSchema, generateSchemasInline, schemaTagMap }: WriteModeProps): Promise<string[]>;
//#endregion
//#region src/writers/tags-mode.d.ts
declare function writeTagsMode({ builder, output, projectName, header, needSchema, generateSchemasInline, schemaTagMap }: WriteModeProps): Promise<string[]>;
//#endregion
 ...
 */
declare function writeTagsOperationsMode({ builder, output, projectName, header, needSchema, generateSchemasInline, schemaTagMap }: WriteModeProps): Promise<string[]>;
//#endregion
 ...
 * working.
 */
declare function writeTagsOperationsSplitMode({ builder, output, projectName, header, needSchema, generateSchemasInline, schemaTagMap }: WriteModeProps): Promise<string[]>;
//#endregion
