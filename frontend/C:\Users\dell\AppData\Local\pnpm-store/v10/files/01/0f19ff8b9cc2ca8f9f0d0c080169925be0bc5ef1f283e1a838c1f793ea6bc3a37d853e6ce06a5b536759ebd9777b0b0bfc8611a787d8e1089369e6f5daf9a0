import { Verbs, generateBodyOptions, generateFormDataAndUrlEncodedFunction, generateVerbImports, getIsBodyVerb, isObject, isOperationInTagBucket, logWarning, pascal, resolveRef, sanitize, toObjectString } from "@orval/core";
//#region src/index.ts
